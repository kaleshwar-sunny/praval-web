      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {/* Description */}
            <p className="text-sm md:text-base leading-relaxed mb-6 font-normal" style={{color: "#FFFFFF"}}>
          ...
          <div>
            ...
            <h4 className="text-white text-base md:text-lg mb-4">Get in touch</h4>
            <div className="flex flex-row gap-6 text-sm md:text-base font-light" style={{color: "#FFFFFF"}}>
