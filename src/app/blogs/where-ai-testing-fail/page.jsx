...
const quickLinks = [
  ...
  { id: "s1", label: "AI Can Generate Tests—but It May Not Understand What Matters" },
  { id: "s2", label: "AI Struggles with Ambiguous Requirements" },
  { id: "s3", label: "AI Can Detect Patterns—but Context Still Matters" },
  { id: "s4", label: "AI Testing Tools Can Miss Real User Behavior" },
  { id: "s5", label: "Self-Healing Automation Can Hide Real Problems" },
  { id: "s6", label: "AI Can Produce False Confidence" },
  { id: "s7", label: "AI Struggles with Business and Domain Context" },
  { id: "s8", label: "AI Does Not Truly Understand Risk the Way Humans Do" },
  { id: "s9", label: "AI Can Struggle with Non-Functional Quality" },
  { id: "s10", label: "AI Can Miss the Difference Between Working and Useful" },
  { id: "s11", label: "AI Needs Human Oversight to Avoid Hallucinations" },
  { id: "s12", label: "Human Judgment Is Most Valuable at Quality Decision Points" },
  { id: "s13", label: "The Future: Human-Led, AI-Augmented Quality Engineering" },
  { id: "s14", label: "What QA Engineers Should Do Next" },
