...
const caseStudyCards = [
  {
    ...
    image: "/images/imagesCaseStudyHomePage/gen-ai.svg",
  ...
  },
  {
    ...
    headline: "Sales were up. Margin was leaking.",
    body: "They asked us to roll out Salesforce for one view of the customer.",
  },
  {
    tag: "FMCG",
    ...
    headline: "The shelves were empty. The warehouse was full.",
    body: "They asked us to build a better demand-forecasting model.",
  },
  {
    tag: "Manufacturing",
    industry: "manufacturing",
    ...
    headline: "The parts passed inspection. The defects shipped anyway.",
    body: "They asked us to turn their paper inspection sheets into an app.",
  },
  // {
  //   tag: "Insurance",
  //   industry: "fcmg",
